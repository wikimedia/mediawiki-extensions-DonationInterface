 ...
 */
require_once dirname( __FILE__ ) . DIRECTORY_SEPARATOR . 'AmazonTestCase.php';

/**
 * AllTests
 */
class DonationInterface_Adapter_Amazon_AllTests {
	...
	public static function suite()
	{
		...
		$suite->addTestSuite( 'DonationInterface_Adapter_Amazon_TestCase' );
