 ...
 */
require_once dirname( __FILE__ ) . DIRECTORY_SEPARATOR . 'AdyenTestCase.php';

/**
 * AllTests
 */
class DonationInterface_Adapter_Adyen_AllTests {
	...
	public static function suite()
	{
		...
		$suite->addTestSuite( 'DonationInterface_Adapter_Adyen_TestCase' );
