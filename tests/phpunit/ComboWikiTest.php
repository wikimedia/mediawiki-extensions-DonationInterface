...
class ComboWikiTest extends DonationInterfaceTestCase {
	...
	public function testOrderIdUserIpAndReferrerCannotBeSetViaQueryParameters(): void {
		...
		$this->assertNotSame(
			'request-supplied-order-id',
			$dataObject->getValue( 'order_id' ),
			'order_id must not be settable via the query string -- it is always server-generated by OrderIdHandler'
		);
