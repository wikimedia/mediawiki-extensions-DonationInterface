	...
	protected function generateBillingFields() {
		...
		*/
		...
		$form .= '<td>' . Xml::radio( 'method', 1, $this->form_data['amount'] == 2 ) . Xml::element( 'img', array( 'src' => $wgScriptPath . "/extensions/DonationInterface/payflowpro_gateway/includes/card-visa.png" ) ) .
			...
			Xml::radio( 'method', 4, $this->form_data['method'] == 4 ) . Xml::element( 'img', array( 'src' => $wgScriptPath . "/extensions/DonationInterface/payflowpro_gateway/includes/card-discover.png" ) ) .
			Xml::radio( 'method', 5, $this->form_data['method'] == 5 ) . Xml::element( 'img', array( 'src' => $wgScriptPath . "/extensions/DonationInterface/payflowpro_gateway/includes/card-paypal.png" ) ) .
			'</td>';
		$form .= '</tr>';
