...
class PayflowProGateway_Form_TwoStepTwoColumnLetter3 extends PayflowProGateway_Form_TwoStepTwoColumn {
	...
	public function generateFormSubmit() {
		...
		$form .= Xml::element( 'input', array( 'src' => $wgScriptPath . "/extensions/DonationInterface/payflowpro_gateway/includes/submit-donation.png", 'alt' => 'Submit donation', 'onclick' => 'submit_form( this )', 'type' => 'submit' ) );
