...
Каб рабіць ахвяраваньне бясьпечным і зручным, нашая форма ахвяраваньня патрабуе JavaScript.',
	...
	'payflowpro_gateway-shipping-address-different' => 'Мой адрас дастаўкі адрозны ад адрасу плацяжу.',
	'payflowpro_gateway-shipping-address-same' => 'Адрас дастаўкі такі ж, як і плацёжны адрас.',
	'payflowpro_gateway-only-billing-address' => 'Цішоткі могуць быць адпраўленыя толькі па плацёжным адрасе.',
	'payflowpro_gateway-donation-must-equal' => 'Ахвяраваньне мусіць ня меншым за $1.',
	'payflowpro_gateway-thank-you' => 'Дзякуй! Вашае ахвяраваньне атрыманае!',
	'payflowpro_gateway-wikipedia-translation' => 'Калі ласка, заўважце: слова «Wikipedia» на рукаве цішоткі нанесеная ў выглядзе сымбалю «Wikipedia 10», які ня будзе перакладзены.',
	'payflowpro_gateway-on-the-back' => 'Пры гэтам на звароце:',
	'payflowpro_gateway-tshirt-confirmation' => 'Вам будзе дасланая цішотка наступнага памеру з надпісам на наступнай мове:',
 ...
 */
$messages['fr'] = array(
	'payflowprogateway' => 'Faites un don maintenant',
