...
Please try again later.',
	...
	'payflowpro_gateway-cvv-explain' => '<h4>What is CVV?</h4><p>Cardholder Verification Value (CVV) these three or four digit numbers help ensure that the physical card is in the cardholder’s possession while donating online that helps to prevent unauthorized or fraudulent use.</p><h4>Visa, Mastercard</h4><p>The 3-digit code is located on the back of your card, inside the signature area. Typically the signature panel will have a series of numbers, but only the last three digits make up the CVV code.</p><h4>Amex</h4><p>The code is ALWAYS located ABOVE the embossed (raised) account number on the face of the card. In some instances, the code is located on the left side of the card, but is always above the account number.</p><br />',
